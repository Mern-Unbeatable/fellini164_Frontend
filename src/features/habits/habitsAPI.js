...
function unwrapSuggestionList(body) {
  ...
  if (Array.isArray(body) && (body[0]?.suggestionId || body[0]?.proposedHabit)) return body;
...
function unwrapSuggestionAction(body) {
  ...
  if (body.proposedHabit || body.suggestionId) return body;
 ...
 * Creates the real habit — do not follow with POST /habits.
 */
