        ...
        return (
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              <p className={`font-['Inter',sans-serif] text-[10px] font-medium text-[#181818] ${task.done ? 'line-through' : ''}`}>
                {task.name}
              </p>
              <div className="mt-1 flex flex-wrap items-center gap-1">
                <span className={`rounded px-1 py-0.5 font-['Inter',sans-serif] text-[7px] font-medium text-[#181818] ${task.timeBg}`}>
                  {task.time}
                </span>
                <span className={`rounded-full border bg-white px-1 py-0.5 font-['Inter',sans-serif] text-[7px] font-medium ${tag.text} ${tag.border}`}>
                  {task.tag}
                </span>
              </div>
            </div>
    ...
    <section ref={secRef} className="w-full bg-white py-12.5 md:py-10">
      <div className="mx-auto max-w-385 px-5 md:px-20">
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          ...
          <div ref={c1} className="rounded-2xl border border-[#f0f0f0] bg-white p-5 shadow-[0_2px_16px_rgba(0,0,0,0.04)]">
            <div className="mb-4 flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#f5f0ff]">
