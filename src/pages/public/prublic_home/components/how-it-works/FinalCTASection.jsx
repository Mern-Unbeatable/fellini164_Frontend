...
export const FinalCTASection = () => {
  ...
  return (
    <div ref={cardRef} className="relative z-20 w-full">
      <div
        className={`relative overflow-hidden rounded-[20px] bg-[#181818] px-5 pt-5 pb-47.5 md:rounded-[30px] md:px-12.5 md:pt-12.5 md:pb-5 lg:h-79.75 lg:pb-12.5 ${FINAL_CTA_SHADOW}`}
      >
        <div ref={textRef} className="relative z-10 flex w-full flex-col gap-5 md:max-w-[55%] md:gap-6 lg:max-w-160 lg:gap-12.5">
          <div className="flex flex-col gap-3.5 md:gap-5">
            <h2 className="font-['Inter',sans-serif] text-[22px] leading-[1.3] font-bold text-white md:text-[26px] lg:text-[34px]">
