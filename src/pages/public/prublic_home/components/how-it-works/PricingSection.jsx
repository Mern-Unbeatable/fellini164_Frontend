...
const PlanCheckIcon = () => (
  <svg width={16} height={16} viewBox="0 0 16 16" fill="none" className="size-3.5 shrink-0 lg:size-4">
...
const PricingCard = ({ plan, cardRef, billing }) => {
  ...
  if (plan.featured) {
    return (
      <div ref={cardRef} className="relative flex w-full flex-col items-center lg:h-full">
        <div
          ...
          <div className="flex w-full flex-col items-center gap-5 lg:gap-7.5">
            ...
            <div className="flex w-full items-start justify-between px-5 md:justify-center md:gap-10 md:px-0 lg:gap-10">
              {['No commitment', 'Cancel anytime', 'Secure payments'].map((t) => (
                <p key={t} className="font-['Inter',sans-serif] text-[10px] leading-normal font-medium text-[#c2c2c2] lg:text-[12px]">
                  {t}
                </p>
              ))}
            </div>
