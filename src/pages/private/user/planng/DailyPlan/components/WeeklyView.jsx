        ...
        <div className="min-w-[950px] w-full flex flex-col flex-1">
          ...
          <div className="grid grid-cols-[64px_1fr_1fr_1fr_1fr_1fr_1fr_1fr] gap-0 border-b border-[#F2F2F2] dark:border-zinc-800/80">
            ...
            {[
              ...
              <div
                key={dayObj.num}
                className="flex flex-col items-center justify-center border-r border-[#F2F2F2] bg-white py-3 text-center last:border-r-0 dark:border-zinc-800/80 dark:bg-zinc-900 min-w-0"
              >
              ...
              >
                ...
                {Array.from({ length: 7 }).map((_, colIndex) => {
                  ...
                  return (
                    <div
                      key={colIndex}
                      className="min-h-[90px] min-w-0 border-r border-[#F2F2F2] bg-white p-2 transition-colors last:border-r-0 hover:bg-gray-50/20 dark:border-zinc-800/80 dark:bg-zinc-900"
                    >
