...
export default function MessagePage() {
  ...
  return (
    <div className="flex h-full w-full py-7.5 max-lg:py-4 max-lg:sm:py-6">
      <div className="flex h-full w-full overflow-hidden rounded-2xl border border-[#f2f2f2] bg-[#fcfcfc] dark:border-zinc-700 dark:bg-zinc-800">
        {/* Left Panel */}
        <div
          className={`${
        ...
        >
          ...
          <div className="shrink-0 border-t border-[#f2f2f2] bg-[#fcfcfc] p-4 dark:border-zinc-700 dark:bg-zinc-800">
            <button
