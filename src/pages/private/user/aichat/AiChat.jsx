  ...
  return (
    <div className="flex h-full w-full py-7.5 max-lg:py-4 max-lg:sm:py-6">
      ...
      <div
        ...
        } h-full w-full shrink-0 flex-col overflow-hidden border-r border-[#f2f2f2] bg-white md:flex md:w-60 lg:w-55 xl:w-80 dark:border-zinc-700 dark:bg-zinc-800`}
      >
        {/* Header - Fixed */}
        <div className="shrink-0 border-b border-[#f2f2f2] bg-white p-3 sm:p-4 dark:border-zinc-700 dark:bg-zinc-800">
          <div className="flex items-center justify-between">
            <p className="text-[16px] font-medium text-[#181818] dark:text-white">Chat History</p>
          </div>
          <div className="mt-3">
            <div className="flex items-center rounded-lg border border-[#f2f2f2] bg-white px-3 py-1.75 dark:border-zinc-700 dark:bg-zinc-800">
        ...
        <div className="shrink-0 border-t border-[#f2f2f2] bg-white p-4 dark:border-zinc-700 dark:bg-zinc-800">
          <button
      ...
      >
        {/* Chat Header - Fixed */}
        <div className="shrink-0 border-b border-[#f2f2f2] bg-white px-4 py-3 dark:border-zinc-700 dark:bg-zinc-800">
